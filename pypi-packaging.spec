...
Source0  : https://files.pythonhosted.org/packages/a1/d4/1fc4078c65507b51b96ca8f8c3ba19e6a61c8253c72794544580a7b6c24d/packaging-25.0.tar.gz
...
%prep
%setup -q -n packaging-25.0
cd %{_builddir}/packaging-25.0
pushd ..
cp -a packaging-25.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745245734
