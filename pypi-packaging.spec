...
Source0  : https://files.pythonhosted.org/packages/d0/63/68dbb6eb2de9cb10ee4c9c14a0148804425e13c4fb20d61cce69f53106da/packaging-24.2.tar.gz
...
%prep
%setup -q -n packaging-24.2
cd %{_builddir}/packaging-24.2
pushd ..
cp -a packaging-24.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731084344
