...
Source0  : https://files.pythonhosted.org/packages/6b/f7/c240d7654ddd2d2f3f328d8468d4f1f876865f6b9038b146bec0a6737c65/packaging-22.0.tar.gz
...
%prep
%setup -q -n packaging-22.0
cd %{_builddir}/packaging-22.0
pushd ..
cp -a packaging-22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672296640
