...
Source0  : https://files.pythonhosted.org/packages/ee/b5/b43a27ac7472e1818c4bafd44430e69605baefe1f34440593e0332ec8b4d/packaging-24.0.tar.gz
...
%prep
%setup -q -n packaging-24.0
cd %{_builddir}/packaging-24.0
pushd ..
cp -a packaging-24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710172831
